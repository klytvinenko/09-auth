...
const EditProfilePage = ()=>{
    ...
    const user = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$store$2f$authStore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAuthStore"])({
        "EditProfilePage.useAuthStore[user]": (s)=>s.user
    }["EditProfilePage.useAuthStore[user]"]);
    const setUser = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$store$2f$authStore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAuthStore"])({
        "EditProfilePage.useAuthStore[setUser]": (s_0)=>s_0.setUser
    ...
    const handleSubmit = async (e)=>{
        ...
        setError("");
        try {
            const updatedUser = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$clientApi$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["updateUser"])({
...
_s(EditProfilePage, "WzoNfiNsks1dh1K/y+PSdfIyo7A=", false, function() {
    return [
