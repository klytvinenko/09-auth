...
const AuthNavigation = ()=>{
    ...
    if ($[0] !== "5545431d063de7042df44e5e5b795bd9b409f6d65d0c29688d83edbcfcec842e") {
        for(let $i = 0; $i < 8; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "5545431d063de7042df44e5e5b795bd9b409f6d65d0c29688d83edbcfcec842e";
    }
        ...
        "AuthProvider.useEffect": ()=>{
            const verify = {
                "AuthProvider.useEffect.verify": async ()=>{
                    ...
                    try {
                        const user = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$clientApi$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["checkClientSession"])();
                        setUser(user);
                    } catch (e) {
                        clearIsAuthenticated();
                        router.push("/sign-in");
...
_s(AuthProvider, "y5lFsYTbQCoNxxPnpGpbVtguax8=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRouter"],
...
//# sourceMappingURL=_32f04956._.js.map